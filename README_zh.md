...
[Web 平台](#web-平台功能) · [CLI 工具](#cli-工具) · [Agent 模板](#agent-registry) · [Composer 编排](#可视化-composer) · [快速上手](#quick-start) · [本地开发](#本地开发) · [Docker 部署](#docker-部署) · [参与贡献](#参与贡献)
...
- **🎨 可视化 Composer** —— 拖拽 Agent 到画布，自动生成调度器和路由规则，撤销/重做/自动布局。
- **👥 团队配方（Recipe）** —— 分享多 Agent 协作架构（如"自媒体 6 人团队"、"研发小队"）。
...
| **Agent 详情** | 查看 IDENTITY.md / SOUL.md、文件列表、一键复制安装命令、ZIP 下载 |
| **可视化 Composer** | 拖拽 Agent 到画布，自动生成调度器和路由规则，撤销/重做/自动布局 |
...
Composer 是 SoulHub 的核心创新功能——在可视化画布上拖拽组合 Agent，自动生成多 Agent 协作架构：
